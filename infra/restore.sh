...
echo "  ./infra/repath.sh /новый/путь/к/тендерам"
echo
echo "В базе ядра лежат абсолютные пути документов. Если архив на сервере"
echo "лежит не там, где на прежней машине, разбор не найдёт ни одного файла."
