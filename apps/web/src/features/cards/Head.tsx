...
/**
 * Сколько осталось до конца приёма.
 *
 * До суток — часы, минуты и секунды: в последний день смотрят именно на них, и
 * в последний час — на секунды.
 *
 * Дальше суток — дни и часы. «149:12:54» человек делит в уме на 24, чтобы
 * понять, что это шесть дней, и ошибается: число из трёх цифр перед двоеточием
 * читается как время, а не как срок. Секунды там не нужны вовсе — за неделю до
 * приёма на них никто не смотрит.
 */
